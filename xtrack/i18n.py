...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "wmtool_color": "Color",
        "wmtool_font_inherited": "Font: {path} · outline {outline} (from X-Track settings)",
        "wmtool_white": "White",
        "wmtool_black": "Black",
        ...
        "wmtool_cyan": "Cyan",
        "wmtool_scale": "Size",
        "wmtool_scale_tip": "Watermark size as % of the frame's longer side. Text uses that percent as font height; images use it as watermark width.",
        "wmtool_opacity": "Opacity",
        "wmtool_fade": "Fade",
        "wmtool_suffix_sec": " s",
        "wmtool_fade_tip": "Fade out before each move, then fade in. 0 is a hard cut. Videos only.",
        "wmtool_hint": "Size follows the longer side. Text height and image width both use that percent. Fade and timed moves apply to video; still images keep opacity and one position.",
    ...
    "zh": {
        ...
        "wmtool_color": "颜色",
        "wmtool_font_inherited": "字体: {path} · 描边 {outline}（与 X-Track 设置一致）",
        "wmtool_white": "白色",
        "wmtool_black": "黑色",
        "wmtool_yellow": "黄色",
        "wmtool_red": "红色",
        "wmtool_cyan": "青色",
        "wmtool_scale": "画面占比",
        "wmtool_scale_tip": "水印大小 = 画面长边的百分比。文字按该比例作为字号高度，图片按该比例作为水印宽度。",
        "wmtool_opacity": "不透明度",
        "wmtool_fade": "渐隐时长",
        "wmtool_suffix_sec": " 秒",
        "wmtool_fade_tip": "每次换位置前淡出、换过去再淡入。0 表示硬切。仅视频。",
        "wmtool_hint": "大小按画面长边计算：文字字号、图片宽度都用这个百分比。渐隐和定时换位只对视频生效；图片使用不透明度，并只落在一个位置。",
        "wmtool_place": "出现方式",
        "wmtool_fixed": "固定位置",
        "wmtool_corners": "四角轮流",
        "wmtool_random": "全屏随机",
